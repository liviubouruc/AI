...
mlp_classifier = MLPClassifier(hidden_layer_sizes=668, max_iter=500)
mlp_classifier.fit(train_images, train_labels)
predicted = mlp_classifier.predict(validation_images)
acc = accuracy_score(validation_labels, predicted)
print(acc)


predicted_test_labels = mlp_classifier.predict(test_images)
