...
rf_classifier = RandomForestClassifier(n_estimators=1500, random_state=19)
rf_classifier.fit(train_images, train_labels)
predicted = rf_classifier.predict(validation_images)
acc = accuracy_score(validation_labels, predicted)
print(acc)


predicted_test_labels = rf_classifier.predict(test_images)
